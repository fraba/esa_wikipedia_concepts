...
```{r graph-wikipedia-category-and-article, echo = FALSE, warning=FALSE, message=FALSE, fig.path='Figs/'}
require(igraph)
...
```{r tsne-cosine-distance-m5s-gmi-discussion, echo = FALSE, message=FALSE, warning=FALSE, fig.width=6, fig.height=9, fig.path='Figs/'}
theme_set(theme_bw() + 
